                ...
                <tbody>
                    ...
                    foreach ($data as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row['id_admin'] ?></td>
                            <td>
                                <a class="badge badge-success" href="page_edit.php?id_kategori=<?= $row['id_kategori']
                                                                                                ?>">Edit</a>
                                <a class="badge badge-danger" href="kategori_delete.php?id_kategori=<?= $row['id_kategori']
